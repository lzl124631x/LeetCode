# [2980. Check if Bitwise OR Has Trailing Zeros (Easy)](https://leetcode.com/problems/check-if-bitwise-or-has-trailing-zeros)
...
**Companies**:
[Meituan](https://leetcode.com/company/meituan)

**Related Topics**:  
[Array](https://leetcode.com/tag/array), [Bit Manipulation](https://leetcode.com/tag/bit-manipulation)

**Similar Questions**:
* [Count Odd Numbers in an Interval Range (Easy)](https://leetcode.com/problems/count-odd-numbers-in-an-interval-range)
* [Remove Trailing Zeros From a String (Easy)](https://leetcode.com/problems/remove-trailing-zeros-from-a-string)
